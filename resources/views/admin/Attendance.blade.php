      ...
      <div class="row">
         ...
         <form method="get">
            <div class="col-md-3">
               ...
               <div class="button_block"> <button type="button" class="btn cur-p btn-outline-success"
                     style="margin-top: 11px;">Check</button></div>

               <a href="/dasboard" class="btn cur-p btn-outline-danger"
                  style="margin-left:89px; margin-top:-47px;">Back</a>
