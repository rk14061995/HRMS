         ...
         <div class="inner_container">
            ...
            <nav id="sidebar">
               ...
               <div class="sidebar_blog_2">
                  <h4><a href="{{ route('adashboard')}}" id="super">Super Admin Panel</a></h4>
                  <ul class="list-unstyled components">
                     <li class="active">
                        ...
                        <ul class="collapse list-unstyled" id="dashboard">
                           <li>
                              <a href="{{ route('astatus')}}"><span>Status Of Work</span></a>
                           </li>
                           <li>
                              <a href="{{ route('aattendance')}}"><span>Attendance</span></a>
                           </li>
                           <li>
                              <a href="{{ route('amedical')}}"><span>Medical Claim Sheet</span></a>
                           </li>
                          
                        </ul>
                     </li>
                     <li><a href="{{ route('aleave')}}"><i class="fa-solid fa-pen-to-square" style="color:#808B96;"></i></i> <span>Leave Approval</span></a></li>
                     
                     <li><a href="{{ route('aregulancer')}}"><i class="fa fa-table" style="color:#808B96;"></i> <span>Attendance Regulation</span></a></li>
                    
                     <li><a href="{{ route('aportfolio')}}"><i class="fa fa-map" style="color:#808B96;"></i> <span>Portfolio</span></a></li>
                     <li><a href="{{ route('acontact')}}"><i class="fa-solid fa-paper-plane" style="color:#808B96;"></i> <span>Contact</span></a></li>
                     <li><a href="{{ route('aadminpermission')}}"><i class="fa fa-cog" style="color:#808B96;"></i> <span>Admin Permission</span></a></li>
                  </ul>
               </div>
            </nav>
            <!-- end sidebar -->
                  ...
                  <nav class="navbar navbar-expand-lg navbar-light">
                     <div class="full">
                        ...
                        <div class="logo_section">
                           <h1 style="color: aliceblue; padding-top:14px;"><b><a href="{{ route('adashboard')}}" id="super">&nbsp;&nbsp;HRMS DashBoard</a></b></h1>
